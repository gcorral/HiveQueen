...
function get_comments_popup_template() {
	...
	if ('' == $template)
		$template = ABSPATH . HQINC . '/theme-compat/comments-popup.php';
...
/**
 * Require the template file with HiveQueen environment.
 *
 * The globals are set up for the template file to ensure that the HiveQueen
...
function load_template( $_template_file, $require_once = true ) {
	global $posts, $post, $hq_did_header, $hq_query, $hq_rewrite, $hqdb, $hq_version, $hq, $id, $comment, $user_ID;

	if ( is_array( $hq_query->query_vars ) ) {
		extract( $hq_query->query_vars, EXTR_SKIP );
	}
