 ...
 * @since 0.0.1
 */
class HQ_Styles extends HQ_Dependencies {
	public $base_url;
	public $content_url;
	...
	public function __construct() {
		/**
		 * Fires when the HQ_Styles instance is initialized.
		 *
		 * @since 0.0.1
		 *
		 * @param HQ_Styles &$this HQ_Styles instance, passed by reference.
		 */
		do_action_ref_array( 'hq_default_styles', array(&$this) );
	}
