 ...
 *
 * These classes were refactored from the HiveQueen HQ_Scripts and HiveQueen
 * script enqueue API.
 *
 * @package BackPress
 * @since 0.0.1
 ...
 *
 * @package BackPress
 * @uses HQ_Dependencies
 * @since 0.0.1
 */
class HQ_Scripts extends HQ_Dependencies {
	...
	public function init() {
		/**
		 * Fires when the HQ_Scripts instance is initialized.
		 *
		 * @since 0.0.1
		 *
		 * @param HQ_Scripts &$this HQ_Scripts instance, passed by reference.
		 */
		do_action_ref_array( 'hq_default_scripts', array(&$this) );
	}
