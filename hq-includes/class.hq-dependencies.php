 ...
 *
 * Classes were refactored from the HQ_Scripts and HiveQueen script enqueue API.
 *
 * @since 0.0.1
 *
 * @package BackPress
...
class HQ_Dependencies {
	...
	/**
	 * An array of queued _HQ_Dependency handle objects.
	 *
	 * @access public
	 * @since 0.0.1
	 * @var array
	...
	/**
	 * An array of _HQ_Dependency handle objects to queue.
	 *
	 * @access public
	 * @since 0.0.1
	 * @var array
	...
	/**
	 * An array of _HQ_Dependency handle objects already queued.
	 *
	 * @access public
	 * @since 0.0.1
	 * @var array
	...
	public function do_items( $handles = false, $group = false ) {
		...
		foreach( $this->to_do as $key => $handle ) {
			if ( !in_array($handle, $this->done, true) && isset($this->registered[$handle]) ) {
				 ...
				 *
				 * Example: The extending class HQ_Scripts is used to register 'scriptaculous' as a set of registered handles:
	...
	public function add( $handle, $src, $deps = array(), $ver = false, $args = null ) {
		if ( isset($this->registered[$handle]) )
			return false;
		$this->registered[$handle] = new _HQ_Dependency( $handle, $src, $deps, $ver, $args );
		return true;
	}
	 ...
	 * @since 0.0.1
	 *
	 * @param array  $queue  An array of queued _HQ_Dependency handle objects.
	 * @param string $handle Name of the item. Should be unique.
