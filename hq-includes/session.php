 ...
 * @since 0.0.1
 */
abstract class HQ_Session_Tokens {
	 ...
	 * the session manager for a subclass of HQ_Session_Tokens.
	 *
	 * @since 0.0.1
	 * @access public
	 * @static
	...
	final public static function get_instance( $user_id ) {
		 ...
		 *                        Default 'HQ_User_Meta_Session_Tokens'.
		 */
		$manager = apply_filters( 'session_token_manager', 'HQ_User_Meta_Session_Tokens' );
 ...
 * @since 0.0.1
 */
class HQ_User_Meta_Session_Tokens extends HQ_Session_Tokens {
