...
class Custom_Background {
	...
	public function __construct($admin_header_callback = '', $admin_image_div_callback = '') {
		...
		add_action( 'hq_ajax_custom-background-add', array( $this, 'ajax_background_add' ) );

		// Unused since 3.5.0.
		add_action( 'hq_ajax_set-background-image', array( $this, 'hq_set_background_image' ) );
	}
...
<td>
<form method="post">
<?php hq_nonce_field('custom-background-remove', '_hqnonce-custom-background-remove'); ?>
...
<td>
<form method="post">
<?php hq_nonce_field('custom-background-reset', '_hqnonce-custom-background-reset'); ?>
...
<td><form enctype="multipart/form-data" id="upload-form" class="hq-upload-form" method="post">
	<p>
		...
		<?php hq_nonce_field( 'custom-background-upload', '_hqnonce-custom-background-upload' ); ?>
...
<?php hq_nonce_field('custom-background'); ?>
...
<?php
	...
	public function handle_upload() {
		...
		do_action( 'hq_create_file_in_uploads', $file, $id ); // For replication
		$this->updated = true;
	}
