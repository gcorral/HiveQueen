...
if ( current_user_can( 'edit_posts' ) )
	$help .= '<p>' . __( '<strong>At A Glance</strong> - Displays a summary of the content on your site and identifies which theme and version of HiveQueen you are using.' ) . '</p>';
...
if ( ! is_multisite() && current_user_can( 'install_plugins' ) )
	$help .= '<p>' . __( '<strong>HiveQueen News</strong> - Latest news from the official HiveQueen project, the <a href="https://planet.wordpress.org/">HiveQueen Planet</a>, and popular and recent plugins.' ) . '</p>';
else
	$help .= '<p>' . __( '<strong>HiveQueen News</strong> - Latest news from the official HiveQueen project, the <a href="https://planet.wordpress.org/">HiveQueen Planet</a>.' ) . '</p>';
if ( current_user_can( 'edit_theme_options' ) )
...
<?php if ( has_action( 'welcome_panel' ) && current_user_can( 'edit_theme_options' ) ) :
	...
	<div id="welcome-panel" class="<?php echo esc_attr( $classes ); ?>">
		<?php hq_nonce_field( 'welcome-panel-nonce', 'welcomepanelnonce', false ); ?>
...
<?php
require( ABSPATH . 'hq-admin/admin-footer.php' );
