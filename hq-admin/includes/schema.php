<?php
/**
 * HiveQueen Administration Scheme API
 *
 ...
 *
 * @global hqdb   $hqdb
 * @global array  $hq_queries
 * @global string $charset_collate
 */
global $hqdb, $hq_queries, $charset_collate;
...
function hq_get_db_schema( $scope = 'all', $blog_id = null ) {
	...
	// Engage multisite if in the middle of turning it on from network.php.
        //TODO: no multisite
	//$is_multisite = is_multisite() || ( defined( 'HQ_INSTALLING_NETWORK' ) && HQ_INSTALLING_NETWORK );
...
CREATE TABLE $hqdb->term_taxonomy (
...
CREATE TABLE $hqdb->term_relationships (
...
function populate_options() {
	...
	*/
	...
	'blogdescription' => __('Just another HiveQueen site'),
	...
	// 3.3
        //TODO: no multisite
	//if ( ! is_multisite() ) {
		$options['initial_db_version'] = ! empty( $hq_current_db_version ) && $hq_current_db_version < $hq_db_version
			? $hq_current_db_version : $hq_db_version;
	//}
	...
	$unusedoptions = array(
		...
		'default_geourl_lon', 'use_default_geourl', 'weblogs_xml_url', 'new_users_can_blog', '_hqnonce',
		'_hq_http_referer', 'Update', 'action', 'rich_editing', 'autosave_interval', 'deactivated_plugins',
		'can_compress_scripts', 'page_uris', 'update_core', 'update_plugins', 'update_themes', 'doing_cron',
		'random_seed', 'rss_excerpt_length', 'secret', 'use_linksupdate', 'default_comment_status_page',
		'hqorg_popular_tags', 'what_to_show', 'rss_language', 'language', 'enable_xmlrpc', 'enable_app',
...
/**
 * Execute HiveQueen role creation for the various HiveQueen versions.
 *
 * @since 0.0.1
 */
...
/**
 * Create the roles for HiveQueen 0.0
 *
 * @since 0.0.1
 */
...
/**
 * Create and modify HiveQueen roles for HiveQueen 0.0
 *
 * @since 0.0.1
 */
...
--The Team @ SITE_NAME' );
	...
	$sitemeta = array(
		...
		'hqmu_upgrade_site' => $hq_db_version,
