 ...
 * @since 0.0.1
 *
 * @return int|HQ_Error HQ_Error or User ID.
 */
function add_user() {
	return edit_user();
}
 ...
 * @return HQ_User|bool HQ_User object on success, false on failure.
 */
...
function get_users_drafts( $user_id ) {
	global $hqdb;
	$query = $hqdb->prepare("SELECT ID, post_title FROM $hqdb->posts WHERE post_type = 'post' AND post_status = 'draft' AND post_author = %d ORDER BY post_modified DESC", $user_id);
