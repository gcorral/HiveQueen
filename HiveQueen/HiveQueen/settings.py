"""
Django settings for hivequeen project.
...
SECRET_KEY = '-&!uoj+fwr@*&#+-!95k38v+6lgsr2mra+aho84wyb$i_+=#s7'
...
WSGI_APPLICATION = 'HiveQueen.wsgi.application'
